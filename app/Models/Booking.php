...
class Booking extends BaseBooking
{
    ...
    const CALENDAR_SHOW = 1;
    const CALENDAR_HIGH = 2;
    ...
    // public function roomschedules()
    // {
    //     return $this->hasMany(RoomSchedule::class, 'booking_id', 'booking_id');
    // }
    ...
    public function bookingtype (){
        return $this->belongsTo(BookingType::class, 'is_ext', 'type_id');
    }
    ...
    public const attributeOptions = [
        'review_status' => [
            ...
            'class' => [
                self::REVIEW_STATUS_PENDING => 'badge bg-warning',
                self::REVIEW_STATUS_APPROVED => 'badge bg-success',
                self::REVIEW_STATUS_REJECTED => 'badge bg-danger'
            ],
            'icon' => [
        ...
        'doc_status' => [
            ...
            'icon' => [
                self::STATUS_DRAFT => 'fa-solid fa-file',
                self::STATUS_PENDING => 'fa-solid fa-clock',
                self::STATUS_APPROVED => 'fa-solid fa-check',
                self::STATUS_REJECTED => 'fa fa-times',
                self::STATUS_CANCELLED => 'fa-solid fa-ban'
            ]
        ]
    ];
